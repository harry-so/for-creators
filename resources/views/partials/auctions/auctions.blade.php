<section class="features section-padding-100 ">
        ...
        <div class="container">
            <div class="section-heading text-center">
                ...
                <h2 class="fadeInUp" data-wow-delay="0.3s">Live auctions <img src="img/art-work/fire.png" width="20" alt=""></h2>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="pricing-item ">
                        <div class="wraper">
                            <a href="{{ url('/item-details') }}"><img src="img/art-work/9.png" alt=""></a>
                            <a href="{{ url('/item-details') }}"><h4>Bored Ape Yacht Club</h4></a>
                            <div class="owner-info">
                                <img src="img/authors/2.png" width="40" alt="">
                                <a href="{{ url('/profile') }}"><h3>@Amillia Nnor</h3></a>
                            </div>
